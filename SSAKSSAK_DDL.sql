...
INSERT INTO Stock_trade (std_id, tch_id, trade_type, quantity, stock_price, trade_date) VALUES
                                                                                            (5, 1, 'B', 9, 103, '2024-01-14'),
                                                                                            (11, 1, 'S', 54, 91, '2024-01-07'),
                                                                                            (14, 1, 'S', 99, 108, '2024-01-31'),
                                                                                            (1, 1, 'S', 62, 90, '2024-01-31'),
                                                                                            (12, 1, 'S', 97, 102, '2024-01-28'),
                                                                                            (14, 1, 'B', 63, 97, '2024-01-09'),
                                                                                            (14, 1, 'S', 4, 102, '2024-01-11'),
                                                                                            (13, 1, 'B', 60, 94, '2024-01-20'),
                                                                                            (18, 1, 'B', 51, 108, '2024-01-19'),
                                                                                            (1, 1, 'B', 83, 103, '2024-01-05'),
                                                                                            (15, 1, 'B', 7, 98, '2024-01-13'),
                                                                                            (11, 1, 'B', 59, 100, '2024-01-11'),
                                                                                            (13, 1, 'S', 97, 103, '2024-01-09'),
                                                                                            (3, 1, 'S', 3, 107, '2024-01-02'),
                                                                                            (12, 1, 'B', 84, 92, '2024-01-25'),
                                                                                            (2, 1, 'B', 32, 96, '2024-01-27'),
                                                                                            (1, 1, 'B', 31, 94, '2024-01-16'),
                                                                                            (4, 1, 'B', 60, 98, '2024-01-25'),
                                                                                            (12, 1, 'B', 78, 109, '2024-01-31'),
                                                                                            (4, 1, 'B', 40, 93, '2024-01-19'),
                                                                                            (1, 1, 'S', 74, 102, '2024-01-13'),
                                                                                            (7, 1, 'B', 76, 110, '2024-01-08'),
                                                                                            (4, 1, 'S', 88, 109, '2024-01-26'),
                                                                                            (4, 1, 'B', 45, 107, '2024-01-14'),
                                                                                            (12, 1, 'B', 65, 110, '2024-01-11'),
                                                                                            (1, 1, 'S', 63, 93, '2024-01-14'),
                                                                                            (12, 1, 'S', 91, 94, '2024-01-14'),
                                                                                            (6, 1, 'S', 79, 107, '2024-01-25'),
                                                                                            (16, 1, 'S', 56, 108, '2024-01-09'),
                                                                                            (11, 1, 'B', 12, 98, '2024-01-29'),
                                                                                            (15, 1, 'B', 97, 104, '2024-01-19'),
                                                                                            (20, 1, 'S', 44, 90, '2024-01-16'),
                                                                                            (11, 1, 'B', 63, 96, '2024-01-12'),
                                                                                            (9, 1, 'S', 36, 109, '2024-01-23'),
                                                                                            (9, 1, 'B', 67, 96, '2024-01-03'),
                                                                                            (8, 1, 'S', 63, 107, '2024-01-25'),
                                                                                            (8, 1, 'S', 83, 105, '2024-01-15'),
                                                                                            (1, 1, 'B', 38, 97, '2024-01-13'),
                                                                                            (8, 1, 'S', 85, 108, '2024-01-12'),
                                                                                            (16, 1, 'S', 55, 107, '2024-01-11');
...
INSERT INTO Quiz (quiz_content, answer1, answer2, answer3, answer4, answer_num, quiz_date) VALUES
                                                                                               ('은행에 돈을 맡기면 받을 수 있는 이자를 무엇이라고 할까요?', '이자', '수수료', '세금', '대출', '1', '2024-10-02'),
                                                                                               ('돈을 빌리고 나중에 갚는 것을 무엇이라고 하나요?', '저축', '대출', '투자', '기부', '2', '2024-10-03'),
                                                                                               ('돈을 모아두고 나중에 쓰는 것을 무엇이라고 할까요?', '대출', '저축', '기부', '수수료', '2', '2024-10-03'),
                                                                                               ('돈을 투자해서 수익을 얻는 것을 무엇이라고 하나요?', '은행', '투자', '주식', '대출', '2', '2024-10-04'),
                                                                                               ('은행에서 돈을 보관하는 방법을 무엇이라고 할까요?', '현금', '카드', '적금', '예금', '4', '2024-10-05'),
                                                                                               ('월급을 받아 생활비로 쓰는 것은 무엇이라고 하나요?', '저축', '대출', '세금', '수수료', '1', '2024-10-06'),
                                                                                               ('사람들이 돈을 모아서 기업에 투자하는 것을 무엇이라고 하나요?', '대출', '투자', '주식', '세금', '2', '2024-10-07'),
                                                                                               ('신용카드를 사용하면 나중에 어떤 것을 해야 하나요?', '지불', '저축', '저축', '대출', '1', '2024-10-08'),
                                                                                               ('돈을 빌릴 때 추가로 내는 비용을 무엇이라고 하나요?', '수수료', '이자', '세금', '대출', '2', '2024-10-09'),
                                                                                               ('돈을 어떻게 관리할지 미리 계획을 세우는 것을 무엇이라고 하나요?', '저축', '대출', '대출', '예산', '4', '2024-10-10');
